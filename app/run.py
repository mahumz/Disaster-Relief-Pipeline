...
df = pd.read_sql_table('myDataTable', engine)

# load vocabulary stats
vocab_counts, vocab_words = joblib.load("../models/vocab.pkl")

# load category stats
category_counts, category_names = joblib.load("../models/category_pkl")

# load model
model = joblib.load("../models/test_classifier.pkl")
